  ...
  <v-container>
            ...
            <v-table>
              <thead>
                <tr>
                  ...
                  <th class="text-left text-black font-weight-bold">Actions</th>
                </tr>
              </thead>
              <tbody>
                <tr
    ...
    <v-row justify="center">
      ...
      >
        <v-card>
          <v-card-title>
            <v-icon @click="isInsertVideo = false">mdi-close</v-icon>
          </v-card-title>
    ...
    <v-row justify="center">
      <v-dialog v-model="isDeleteVideo" persistent width="30%">
        <v-card>
...
export default {
  ...
  // },
  mounted() {
    this.tempAttachment = this.videoFile;
  ...
  methods: {
    ...
    onVideoInput(e) {
      ...
      this.video = files[0];
      this.video.video_path = URL.createObjectURL(files[0]);
    },
    ...
    saveNewVideo() {
      this.tempAttachment[0] = {
        file: {
          ...
          file: this.video.video_path,
          format: this.video.type,
        },
      };
      // console.log(this.tempAttachment);
      this.documentAttachmentAPI = this.video;
      this.$emit('update-video-file', this.documentAttachmentAPI);
      this.isInsertVideo = false;
    },
