      ...
      <v-row>
        <v-col cols="12">
          <v-table class="country-table">
            <thead>
              <tr>
                <th class="text-left font-weight-bold text-black" style="width: 100px">ID</th>
                <th class="text-left font-weight-bold text-black"></th>
                <th class="text-left font-weight-bold text-black">Position Title</th>
                <th class="text-left font-weight-bold text-black">Partner Name</th>
                ...
                <tr class="country-table-body">
                  ...
                  <td>
                    <div class="d-flex align-center">
                      <v-btn variant="text" :disabled="isDeleteLoading" @click="editLocation(item)"
                        ><span style="font-size: 12px" class="text-blue-darken-4 text-none"
                          >Edit</span
                        ></v-btn
                      >
                      <v-btn
                  ...
                  <td colspan="10">
                    <div class="d-flex flex-column justify-start">
                      <v-table class="text-left pl-16">
                        <tr>
                          <td class="pl-16 pb-4">
                            <div class="d-flex justify-start pl-16" style="gap: 20px">
                              <p class="font-weight-bold">
                                Views :
                                <span class="text-blue-darken-4">{{ item?.views || 0 }}</span>
                              </p>
                              <p>|</p>
                              <p class="font-weight-bold">
                                Likes :
                                <span class="text-blue-darken-4">{{ item?.likes || 0 }}</span>
                              </p>
                              <p>|</p>
                              <p class="font-weight-bold">
                                Shares :
                                <span class="text-blue-darken-4">{{ item?.shares || 0 }}</span>
                              </p>
                            </div>
                          </td>
                        </tr>
                              ...
                              <v-col class="d-flex flex-wrap" cols="7">
                                ...
                                >
                                  ...
                                  <v-icon
                                    color="red"
                                    small
                                    @click="deleteTagById(tagItem.mjt_id, item.loadingTag)"
                                  >
                                    mdi-close
                                  </v-icon>
                                </v-chip>
