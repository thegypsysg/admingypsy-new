          ...
          <v-table class="country-table">
            <thead>
              <tr>
                ...
                <th class="text-left font-weight-bold text-black">Tag Header Name</th>
                <th class="text-left font-weight-bold text-black">Short</th>
                <th class="text-left font-weight-bold text-black">Description</th>
                <th class="text-left font-weight-bold text-black">Sub Industry</th>
            ...
            <tbody>
              <template v-for="item in filteredItems" :key="item.id">
                <tr class="country-table-body">
                  ...
                  <td>
                    <div class="d-flex">
                      <v-btn color="green" variant="text" @click="editTagHeader(item)" icon>
