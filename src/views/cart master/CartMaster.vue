...
export default {
  ...
  methods: {
    ...
    getItemDescription(del) {
      ...
      } else if (del?.biryani_run_price2) {
        if (del?.biryani_run_price2?.actual_dish_name) {
          return del.biryani_run_price2.actual_dish_name;
        } else if (del?.biryani_run_price2?.dish?.dish_name) {
          return del.biryani_run_price2.dish.dish_name;
        }
      } else {
