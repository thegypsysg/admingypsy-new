...
import ParkingInfoMainInfo from './ParkingInfoMainInfo.vue';

export default {
  name: 'ParkingInfoMainInfoContainer',
  components: { SidebarDashboard, HeaderDashboard, ParkingInfoMainInfo },
  data: () => ({
    drawer: true,
  }),
  // created() {
