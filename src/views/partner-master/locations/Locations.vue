      ...
      <v-row>
        <v-col cols="12">
          <v-table class="country-table">
            <thead>
              <tr>
                <th class="text-left font-weight-bold text-black">Location ID</th>
                <th class="text-left font-weight-bold text-black">Image</th>
                <th class="text-left font-weight-bold text-black"></th>
                <th class="text-left font-weight-bold text-black">Location Name</th>
        ...
        .then((response) => {
          ...
          this.items = data.map((item) => {
            return {
              ...
              isPrimary: item.primary == 'N' ? false : item.primary == 'Y' ? true : null,
              isFavorite: item.favorite == 'N' ? false : item.favorite == 'Y' ? true : null,
            };
          });
        })
        .catch((error) => {
