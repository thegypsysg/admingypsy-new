...
<template>
  <v-container>
    ...
    <v-sheet class="py-6 px-4 mt-10" border rounded width="100%">
      ...
      <v-row>
        <v-col cols="12">
            ...
            <tbody>
              <template v-for="item in filteredItems" :key="item.id">
                <tr class="country-table-body">
                  ...
                  <td>
                    <div class="d-flex">
                      <v-btn color="green" variant="text" @click="editPartner(item)" icon>
          ...
          <skeleton-table v-if="isLoading" :rows="5" :columns="12" />
          <empty-state
    ...
    <v-dialog persistent width="auto" v-model="isOpenImage">
      <v-card width="750">
        <v-card-title class="upload-title px-6 py-4"> Upload Image - Partner</v-card-title>
        <v-card-text>
          <image-upload
    ...
    <v-dialog persistent width="auto" v-model="isOpenLogo">
      <v-card width="750">
        <v-card-title class="upload-title px-6 py-4"> Upload Logo - Partner</v-card-title>
        <v-card-text>
          <image-upload
            :image-file="logoFile"
