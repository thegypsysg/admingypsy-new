...
<template>
  <v-container>
            ...
            <tbody>
              <template v-for="item in filteredItems" :key="item.id">
                <tr class="country-table-body">
                  ...
                  <td>
                    <div class="d-flex">
                      <v-btn color="green" variant="text" @click="editPartnerContact(item)" icon>
                ...
                <tr>
                  <td></td>
                  <td class="pb-2" colspan="6" style="border-top: none !important">
    ...
    <confirm-dialog
      ...
      @confirm="deletePartnerContact"
    />
    <v-dialog persistent width="auto" v-model="isOpenImage">
      <v-card width="750">
        <v-card-title class="upload-title px-6 py-4"> Upload Image - Visiting Card</v-card-title>
        <v-card-text>
          <image-upload
...
export default {
  ...
  methods: {
    ...
    deleteImageFile() {
      this.isSending = true;
      axios
        .delete(`/partner-contacts/${this.partnerContactDataToImage.id}/visiting-card`)
        .then((response) => {
