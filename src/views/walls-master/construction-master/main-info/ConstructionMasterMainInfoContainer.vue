...
import ConstructionMasterMainInfo from './ConstructionMasterMainInfo.vue';

export default {
  name: 'ConstructionMasterMainInfoContainer',
  components: { SidebarDashboard, HeaderDashboard, ConstructionMasterMainInfo },
  data: () => ({
    drawer: true,
  }),
  // created() {
