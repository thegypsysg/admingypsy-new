...
import PropertyDevelopments from './PropertyDevelopments.vue';

export default {
  name: 'PropertyDevelopmentsContainer',
  components: { SidebarDashboard, HeaderDashboard, PropertyDevelopments },
  data: () => ({
    drawer: true,
  }),
  // created() {
