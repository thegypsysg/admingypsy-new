...
import PropertyDevelopmentsMainInfo from './PropertyDevelopmentsMainInfo.vue';

export default {
  name: 'PropertyDevelopmentsMainInfoContainer',
  components: { SidebarDashboard, HeaderDashboard, PropertyDevelopmentsMainInfo },
  data: () => ({
    drawer: true,
  }),
  // created() {
