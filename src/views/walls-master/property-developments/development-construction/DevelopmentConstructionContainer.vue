...
import DevelopmentConstruction from './DevelopmentConstruction.vue';

export default {
  name: 'DevelopmentConstructionContainer',
  components: { SidebarDashboard, HeaderDashboard, DevelopmentConstruction },
  data: () => ({
    drawer: true,
  }),
  // created() {
