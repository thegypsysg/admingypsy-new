...
import ConstructionCategory from './ConstructionCategory.vue';

export default {
  name: 'ConstructionCategoryContainer',
  components: { SidebarDashboard, HeaderDashboard, ConstructionCategory },
  data: () => ({
    drawer: true,
  }),
  // created() {
...
./ConstructionCategory.vue./ConstructionCategory.vue
