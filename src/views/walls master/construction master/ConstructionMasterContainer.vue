...
import ConstructionMaster from './ConstructionMaster.vue';

export default {
  name: 'ConstructionMasterContainer',
  components: { SidebarDashboard, HeaderDashboard, ConstructionMaster },
  data: () => ({
    drawer: true,
  }),
  // created() {
