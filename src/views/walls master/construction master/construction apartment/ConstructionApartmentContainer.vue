...
import ConstructionApartment from './ConstructionApartment.vue';

export default {
  name: 'ConstructionApartmentContainer',
  components: { SidebarDashboard, HeaderDashboard, ConstructionApartment },
  data: () => ({
    drawer: true,
  }),
  // created() {
