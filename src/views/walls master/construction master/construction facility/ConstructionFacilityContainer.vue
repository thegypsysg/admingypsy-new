...
import ConstructionFacility from './ConstructionFacility.vue';

export default {
  name: 'ConstructionFacilityContainer',
  components: { SidebarDashboard, HeaderDashboard, ConstructionFacility },
  data: () => ({
    drawer: true,
  }),
  // created() {
