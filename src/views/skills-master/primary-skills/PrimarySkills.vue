...
<template>
  <v-container>
            ...
            <tbody>
              <template v-for="item in filteredItems" :key="item.id">
                <tr class="country-table-body">
                  ...
                  <td>
                    <div class="d-flex">
                      <v-btn color="green" variant="text" @click="editPrimarySkill(item)" icon>
                    ...
                    <div class="d-flex" style="gap: 20px">
                      <v-table class="text-left">
                        <tr class="d-flex align-start" style="gap: 65px">
                          ...
                          <td class="pt-2">
                            <span class="text-black font-weight-black">App Name: </span
                            ><span class="text-blue-darken-4 font-weight-bold">{{ item.app }}</span>
                          </td>
                          <td>
                            <div class="pt-2 text-red-darken-4 font-weight-bold">Stand Alone</div>
                            <div class="pt-4 pb-1">
                              <v-btn-toggle
                                style="
                                  font-size: 10px !important;
    ...
    <confirm-dialog
      ...
      @confirm="deletePrimarySkill"
    />
    <v-dialog persistent width="auto" v-model="isOpenImage">
      <v-card width="750">
        <v-card-title class="upload-title px-6 py-4"> Upload Image - Primary Skills</v-card-title>
        <v-card-text>
          <image-upload
          ...
          this.items = data
            ...
            .map((item) => {
              return {
                ...
                isStandAlone:
                  item.stand_alone == 'N' ? false : item.stand_alone == 'Y' ? true : null,
              };
            });
        })
        .catch((error) => {
